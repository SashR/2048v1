...
export default function RedFlag(){
    ...
    return (
        <>
            <svg className="z-30" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 116.8 122.88">
                <defs>
                    <style>{`
                    .cls-1{fill:#e21b1b;}
                    .cls-2{fill:#1a1a1a;}
